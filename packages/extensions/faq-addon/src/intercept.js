  ...
  targets.of('@magento/venia-ui').routes.tap(
  	routesArray => {
  		routesArray.push({
  			name: 'HomePage',
  			pattern: '/faq.html',
  			path: '@landofcoder/faq-addon/src/components/HomePage/index.js'
  		})
      routesArray.push({
        name: 'Category',
        pattern: '/faq/category/:categoryUrl?',
        path: '@landofcoder/faq-addon/src/components/Category/index.js'
      })
      routesArray.push({
        name: 'Article',
        pattern: '/faq/article/:articleUrl?',
        path: '@landofcoder/faq-addon/src/components/Article/index.js'
      })
  		return routesArray
  	}
  )
